...
class FlatArcGauge:
    ...
    def __prepare_constant_elements__(self, base_size, surface_flags):
        ...
        self._static_elements_surface.blit(pygame.transform.smoothscale(gauge_base_surface, base_size), (0, 0))
    ...
    def draw_update(self, value):
        ...
        if self._config.rotation_buffer_degrees < arc_transposed_value:
