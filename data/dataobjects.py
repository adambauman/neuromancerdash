...
class DashData:
    ...
    cpu_opt_fan = DataField("cpu_opt_fan", "Forward Exhaust Fan Speed", Units.rpm, warn_value=300, min_value=500, max_value=1400)
    chassis_1_fan = DataField("chassis_1_fan", "Front Intake Fan Speed", Units.rpm, warn_value=300, min_value=500, max_value=1500)
    chassis_2_fan = DataField("chassis_2_fan", "Lower Intake Fan Speed", Units.rpm, warn_value=300, min_value=500, max_value=1400)
    chassis_3_fan = DataField("chassis_3_fan", "Rear Exhaust Fan Speed", Units.rpm, warn_value=300, min_value=500, max_value=1400)
